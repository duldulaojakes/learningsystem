...
<div align="center" id="content">
 <?php 
    ...
    <tr><th>ID</th><th>CodeNumber</th><th>Lastname</th><th>Firstname</th><th>Middlename</th><th>Address</th><th>Age</th><th>Birthday</th><th>Username</th><th>Password</th><th>Edit</th><th>Delete</th></tr>	
		<?php
			$dbhost = 'localhost';
			$dbuser = 'root';
			$dbpass = '';
			...
			while($row = mysql_fetch_array($retval, MYSQL_ASSOC)){
				...
				.$row['age'].'</td><td>'.$row['birthday'].'</td><td style="text-align: left;">'
				.$row['username'].'</td><td style="text-align: left;">'.$row['password'].'</td><td><a href="adminedit.php?id='.$row['studentid'].'&status=edit'.'"><img src="../images/edit.png"></a></td><td><a href="admindelete.php?id='.$row['studentid'].'"><img src="../images/delete.png"></a></td></tr>';
			} 
			mysql_close($conn);
		?>
    </table>
